        ...
        <div id='#Photography' className="parallax-item4">
          ...
          <div className="carousel">
            <ul className="carousel__list">
              ...
              <li className="carousel__item" data-pos="-3">7</li>
              <li className="carousel__item" data-pos="3">6</li>
              <li className="carousel__item" data-pos="-4">8</li>
              <li className="carousel__item" data-pos="4">9</li>
              <li className="carousel__item" data-pos="-5">10</li>
              <li className="carousel__item" data-pos="5">11</li>
            </ul>
          </div>
          <div className="chalo">
